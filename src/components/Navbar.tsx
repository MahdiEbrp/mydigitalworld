...
const Navbar = () => {
    ...
    const NavContainer = (props: { children: ReactElement | ReactElement[]; }) => {
        ...
        return (
            <>
                <nav className='sticky top-0 z-30 w-full sm:max-h-20 shadow-lg p-3 bg-primary-800'>
    ...
    const HamburgerButton = () => {
        return (
            <button
                onClick={toggleMenu}
                type='button'
                className='inline-flex sm:hidden items-center justify-center p-2 rounded-md text-primary-950 opacity-80 hover:opacity-100 active:-rotate-180 transition duration-500 ease-in-out hover:animate-pulse'
