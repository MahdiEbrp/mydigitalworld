...
const BookDetails = ({ book }: BookProps) => {
    return (
        <>
            <ImageLoader className='rounded transform hover:scale-90 transition duration-500' src={book.cover} alt={`${book.title}-${book.author}-cover`} width={200} height={200} />
